...
private:
    ...
    void create_swap_chain() {
        ...
        vk::SwapchainCreateInfoKHR swapChainCreateInfo{
            ...
            .imageFormat = swap_chain_image_format, .imageColorSpace = vk::ColorSpaceKHR::eSrgbNonlinear,
    ...
    void create_image_views() {
        vk::ImageViewCreateInfo imageViewCreateInfo{ .viewType = vk::ImageViewType::e2D, .format = swap_chain_image_format,
    ...
    void create_graphics_pipeline() {
        ...
        vk::GraphicsPipelineCreateInfo pipelineInfo{ .pNext = &pipelineRenderingCreateInfo,
            ...
            .pDynamicState = &dynamicState, .layout = pipeline_layout, .renderPass = nullptr };
    ...
    void create_command_buffers() {
        ...
        vk::CommandBufferAllocateInfo allocInfo{ .commandPool = command_pool, .level = vk::CommandBufferLevel::ePrimary,
    ...
    void draw_frame() {
        ...
        const vk::SubmitInfo submitInfo{ .waitSemaphoreCount = 1, .pWaitSemaphores = &*present_complete_semaphore[semaphore_index],
                            .pWaitDstStageMask = &waitDestinationStageMask, .commandBufferCount = 1, .pCommandBuffers = &*command_buffers[current_frame],
                            .signalSemaphoreCount = 1, .pSignalSemaphores = &*render_finished_semaphore[imageIndex] };
        graphics_queue.submit(submitInfo, *in_flight_fences[current_frame]);


        const vk::PresentInfoKHR presentInfoKHR{ .waitSemaphoreCount = 1, .pWaitSemaphores = &*render_finished_semaphore[imageIndex],
                                                .swapchainCount = 1, .pSwapchains = &*swap_chain, .pImageIndices = &imageIndex };
